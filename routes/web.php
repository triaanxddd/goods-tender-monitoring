...
use App\Http\Controllers\{DashboardController, UserController, RoleController, TaskController};
...
Route::group([
	...
	//Task 
	Route::get('/manage', [TaskController::class, 'manage']);
	Route::get('/manage/{task}', [TaskController::class, 'show']);
	Route::get('/tasks/delete_file/post-files/{file}/{track}', [TaskController::class, 'delete_file']);
	Route::get('/tasks/checkSlug', [TaskController::class, 'checkSlug']);
